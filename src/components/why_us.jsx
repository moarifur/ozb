                ...
                <div className="row">
                    <div className="col-lg-4 d-flex align-items-stretch">
                        <div className="content">
                            {/*<h3>Why Choose Us?</h3>*/}
                            {/*<img src="assets/img/whyUs.jpg" className="img-fluid" alt="" />*/}
                            ...
                            <div className="row">
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>
                                            Participants actively engage in practical activities and
                                            exercises in a real-world context through practice.
                                        </p>
                                ...
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>
                                            Assess your skills, interests, and values to make an action plan
                                ...
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>
                                            The increasing demand for digital services need IT professionals who can
                                            support remotely as well.
                                        </p>
                                        {/*<CollapsibleText collapsedLength={120}>*/}
                                        {/*    <p>*/}
                                        {/*        <p>*/}
