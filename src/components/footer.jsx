        ...
        <footer id="footer">
            <div className="footer-top">
                <div className="container">
                    ...
                    {/*        <h3>Oz Bangla Academia</h3>*/}
                    {/*        <p>*/}
                    {/*            25/C Green Road, Kolabagan*/}
                    {/*            <br />*/}
                    {/*            Dhaka <br />*/}
                    {/*            <br />*/}
                    {/*            <strong>Phone:</strong>*/}
                    {/*            <br />*/}
                    {/*            <strong>Email:</strong> ozbanglaacademia@gmail.com*/}
                    {/*            <br />*/}
                    {/*        </p>*/}
                    {/*    </div>*/}
            ...
            <div className="container d-md-flex py-4">
                <div className="me-md-auto text-center text-md-start">
                    ...
                    <div className="credits">
                        ...
                        Designed by <a href="https://bootstrapmade.com/">Mohammad Arifur Rahman</a>
                    </div>
                </div>
